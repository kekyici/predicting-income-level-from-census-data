...
class DataProcessor:
    ...
    def transform_data(self):
        ...
        self.data['occupation'] = self.data['occupation'].replace(
            {'Protective-serv': 'Brown_collar/P  streamlit run /workspaces/predicting-income-level-from-census-data/streamlit_app.protective_service', 'Armed-Forces': 'Brown_collar/Protective_service'})
        self.data['occupation'] = self.data['occupation'].replace(
